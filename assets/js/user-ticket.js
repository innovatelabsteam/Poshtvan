jQuery(document).ready(function($){
    ...
    $('.submit-new-ticket').on('click', function(e){
        let mw_this = $(this),
            ...
            orderID = $(document).find('.extra_fields select#mihanticket_woocommerce_order option:selected');
        let data = {
            action: 'mwtc_submit_new_ticket',
            title: title,
            content: content,
            mihanticket_woocommerce_order: orderID.val(),
            product_id: orderID.data('product-id')
        }
